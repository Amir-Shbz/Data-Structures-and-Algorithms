...
# and bobSizes where aliceSizes[i] is the number of candies of the ith box of candy that Alice has 
...
# they both have the same total amount of candy. The total amount of candy a person has is the sum of the 
